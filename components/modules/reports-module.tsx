    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Visualiza la actividad del sistema, desempeno de cajeros y logs de seguridad.
        </p>
      </div>
                ...
                <div className="space-y-4">
                  ...
                  {!isLoading &&
                    ...
                    events.map((event) => (
                      <div
                        key={event.id}
                        className="flex items-start gap-4 p-4 rounded-lg border bg-muted/30 hover:bg-muted/50 transition-all"
                      >
